...
export const useStore = create<SentinelState>((set, get) => ({
  ...
  shelters: [
    { id: 's1', name: 'Sylmar Recreation Center', address: '13100 Borden Ave, Sylmar CA', lat: 34.29, lng: -118.44, currentOccupancy: 320, totalCapacity: 400, linkedDamageZoneId: null, linkedDamageProbability: null, status: 'available' },
    { id: 's2', name: 'Van Nuys Recreation Center', address: '14201 Friar St, Van Nuys CA', lat: 34.19, lng: -118.45, currentOccupancy: 180, totalCapacity: 350, linkedDamageZoneId: null, linkedDamageProbability: null, status: 'available' },
    { id: 's3', name: 'Chatsworth Park', address: '22360 Devonshire St, Chatsworth CA', lat: 34.26, lng: -118.60, currentOccupancy: 50, totalCapacity: 200, linkedDamageZoneId: null, linkedDamageProbability: null, status: 'available' },
  ],
  hospitals: [
    { id: 'h1', name: 'Cedars-Sinai Medical Center', address: '8700 Beverly Blvd, LA CA', lat: 34.075, lng: -118.381, remainingCapacity: 120, alertLevel: 'normal', linkedDamageZoneId: null, linkedDamageProbability: null, lastUpdated: new Date() },
    { id: 'h2', name: 'UCLA Medical Center', address: '757 Westwood Plaza, LA CA', lat: 34.066, lng: -118.446, remainingCapacity: 85, alertLevel: 'normal', linkedDamageZoneId: null, linkedDamageProbability: null, lastUpdated: new Date() },
    { id: 'h3', name: 'Providence St. Joseph', address: '501 S Buena Vista St, Burbank CA', lat: 34.18, lng: -118.31, remainingCapacity: 60, alertLevel: 'normal', linkedDamageZoneId: null, linkedDamageProbability: null, lastUpdated: new Date() },
  ],
  evacRoutes: [],
    ...
    set((s) => {
      ...
      return {
        actionCards: [card, ...s.actionCards].sort((a, b) => {
          ...
          const sensOrder = { IMMEDIATE: 0, HIGH: 1, MEDIUM: 2 };
          return sensOrder[a.timeSensitivity] - sensOrder[b.timeSensitivity];
        }),
      };
    }),
